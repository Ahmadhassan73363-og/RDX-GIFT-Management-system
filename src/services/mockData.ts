...
export const INITIAL_REQUESTS: GiftRequest[] = [
  ...
  },
  {
    ...
    totalApprovalSteps: 4,
    currentApproverRole: 'Assistant',
    teamRemainingBudgetAtRequest: 2800,
    budgetAfterApproval: -525,
    submittedByUserId: 'usr-5',
    submittedByUserName: 'Lucas Hayes',
    submittedByUserEmail: 'lucas.hayes@enterprise.com',
    attachments: [],
    comments: [
      {
        id: 'c-4',
    ...
    approvalHistory: [
      {
        ...
        userEmail: 'marcus.brody@enterprise.com',
        action: 'approve',
        comments: 'Conditional on budget clearance.',
        digitalSignature: 'MBrody_Cond',
        ipAddress: '192.168.1.102',
      ...
      },
      {
        ...
        userEmail: 'sophia.chen@enterprise.com',
        action: 'reject',
        comments: 'Declined due to budget deficit and speaker compliance limit.',
        digitalSignature: 'SChen_Declined',
        ipAddress: '192.168.1.115',
        timestamp: '2026-02-22T10:02:00Z'
      }
    ],
    createdAt: '2026-02-20T16:00:00Z',
    updatedAt: '2026-02-22T10:02:00Z'
  },
  {
    id: 'req-6',
    ...
    totalApprovalSteps: 4,
    currentApproverRole: 'Executive',
    teamRemainingBudgetAtRequest: 6550,
    budgetAfterApproval: 5853,
    submittedByUserId: 'usr-7',
    submittedByUserName: 'Sarah Jenkins',
    submittedByUserEmail: 'sarah.jenkins@enterprise.com',
    attachments: [],
    comments: [],
    approvalHistory: [],
